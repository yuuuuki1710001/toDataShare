...
def nodeLogger(log_data, influx_client):
    ...
    data_value5 = log_data['timestamp_start1']
    data_value6 = log_data['timestamp_start2']
    data_value7 = log_data['timestamp_start3']
    data_value8 = log_data['timestamp_start4']
    ...
    data_value5 = isfloat(isfloat(timestamp1) - isfloat(data_value5))
    data_value6 = isfloat(isfloat(timestamp2) - isfloat(data_value6))
    data_value7 = isfloat(isfloat(timestamp3) - isfloat(data_value7))
    data_value8 = isfloat(isfloat(timestamp4) - isfloat(data_value8))
    ...
    tn1 = datetime.datetime.fromtimestamp(data_value5, tz=JST)
    tn2 = datetime.datetime.fromtimestamp(data_value6, tz=JST)
    tn3 = datetime.datetime.fromtimestamp(data_value7, tz=JST)
    tn4 = datetime.datetime.fromtimestamp(data_value8, tz=JST)

    timestamp1 = ts1.astimezone(UTC).replace(tzinfo=None).isoformat()

    mem_name = "doly_monitoring4"
    ...
    data_to_db = [
                    {"measurement": mem_name,
                     ...
                     "fields": {
                         ...
                         "timestamp_start1": data_value5,
                         "timestamp_start2": data_value6,
                         "timestamp_start3": data_value7,
                         "timestamp_start4": data_value8
                         }
                     }
                  ]
    print(f'{data_to_db}')  
